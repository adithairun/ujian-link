                    ...
                    <div class="templatemo-content">
						...
						<!-- MENU MAPEL HARI 1 KELAS XI -->
						 ...
						 <h2> HARI 1 KELAS XI</h2>
                           <div class="row">
                                ...
                                <div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 margin-bottom-20">
                                    <a href="https://forms.gle/wHsG7b7u6uiqE5kt7">
                                        <div class="black-bg btn-menu">
                                            <i class="fa fa-book"></i>
						...
						<h2> HARI 3 KELAS XI</h2>
                            <div class="row">
								...
								<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 margin-bottom-20">
                                    <a href="https://docs.google.com/forms/d/e/1FAIpQLSf99DWTY3PEQTla7vAZbp_9KfeX_VCw70qL2U_DN2Qc2PBDuQ/viewform">
                                        <div class="black-bg btn-menu">
                                            <i class="fa fa-book"></i>
								...
								<div class="col-xs-6 col-sm-3 col-md-3 col-lg-3 margin-bottom-20">
                                    <a href="LINK SOAL">
                                        <div class="black-bg btn-menu">
                                            <i class="fa fa-book"></i>
                                            <h2>BAHASA DAN SASTRA INDONESIA<br> KELAS XI</h2>
                                        </div>
                                    </a>
                                </div>
                            </div>
