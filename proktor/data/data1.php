      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="post" enctype="multipart/form-data" action="format.php">

              	<input class="btn-primary btn-align " name="upload" type="submit" value="Reset Data">
              </form>
		...
		$no=1;
		$data = mysqli_query($koneksi,"select * from tbl_pelulusan ORDER BY kelas ASC");
