...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	$id = $_GET['id'];
	$query_mysql = mysqli_query($koneksi,"SELECT * FROM admin WHERE id='$id'")or die(mysql_error());
	...
	?>
			  ...
			  <form  onsubmit="return validation()" autocomplete="off" action="update_admin.php" method="post">	
		...
		<tr>
			...
			<tr>
				<td>Admin</td>
				<td><input type="radio" name="admin" id="admin1" value="1" <?php if($data['admin']=='1') echo " checked";?> />Ya &nbsp;&nbsp;
						<input type="radio" name="admin" id="admin0" value="0" <?php if($data['admin']=='0') echo " checked";?> />Tidak</td>					
			</tr>
			<tr>
				<td></td>
