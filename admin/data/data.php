...
<head>
  ...
  <title>Admin Kelulusan | Data</title>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../home.php" class="brand-link">
      <img src="../dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Admin Kelulusan</span>
    </a>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h3 class="card-title">Data Kelulusan Siswa</h3>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
              
			  <a  href="format.php"  onclick="return confirm('Seluruh Data Akan Dihapus')"><button class="btn-primary btn-align ">Format Data</button></a>
		...
		$no=1;
		$data = mysqli_query($koneksi,"select * from tbl_pelulusan ORDER BY tahunlulus ASC, kelas ASC");
	...
	if(isset($_GET['berhasil'])){
		echo " Data berhasil di import.</p>";
	}
	?>
