...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<table class="table table-bordered table-hover">
		...
		$no=1;
		$data = mysqli_query($koneksi,"select * from token ORDER BY id ASC");
		while($row = mysqli_fetch_array($data)){
			...
			<tr>
				...
				<td><?php echo $row['kodetoken']; ?></td> 
				<td><a href="edit.php?id=<?php echo $row['id'];?>" title="edit data"><button class="btn-primary">Edit</button></a>
				<!--<a href="hapus.php?id=<?php echo $row['id'];?>" onclick="return confirm('Data Siswa Akan Dihapus')"><button class="btn-danger">Hapus</button></a> --></td>
			</tr>
			<?php
			}
			?>
