        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
			  ...
			  <form autocomplete="off" action="tambah_aksi.php" method="post">	
...
<tr>				
			...
			<tr>
				<td>Admin</td>
				<td><input type="radio" name="admin" id="admin1" value="1"  />Ya &nbsp;&nbsp;
						<input type="radio" name="admin" id="admin0" value="0" />Tidak</td>					
			</tr>				
			</tr>	
