        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview menu-close">
            ...
            <!--  <li class="nav-item">
				...
				<li class="nav-item">
                <a href="token.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Edit Data</p>
                </a>
              </li>
              ...
              <table  class="table table-hover text-wrap">
               <tr>
				...
				<td>
					...
					<input pattern=".{6,}" required title="Kode Token Wajib 6 Huruf" type="text" maxlength="6" id="kodetoken" name="kodetoken" placeholder="<?php echo $data['kodetoken'] ?>" onkeyup="this.value = this.value.toUpperCase()" required">
				</td>					
			</tr>	
		
			<tr>
				<td></td>
				<td><input class="btn-primary btn-align " type="submit" value="Simpan"> <button class="btn-warning" id="button" onclick="getElementById('kodetoken').value=randomStr(6, 'QWERTYUIOPASDFGHJKLZXCVBNM');">Auto Save Token</button></td>					
			</tr>
		  
              </table>
			  </div>
			  </form><button class="btn-danger" id="button" onclick="getElementById('kodetoken').value=randomStr(6, 'QWERTYUIOPASDFGHJKLZXCVBNM');">Acak Token</button></td>
