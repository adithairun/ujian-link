				...
				?>
										...
										<tr class="del_student<?php echo $fetch['id_soal']?>">
												...
												<center>
													...
													<a href="hapus_soal.php?id_soal=<?php echo $fetch['id_soal'];?>"
														onclick="return confirm('Hari Akan Dihapus, Lanjutkan ?')"><button
															class="btn btn-warning"> <span class="ion-trash-a"></span>
															Hapus Hari</button></a>
											...
											<?php
														 ...
														 //$query1 = "SELECT hari.id_hari, hari.nama_hari, kelas.id_kelas, kelas.nama_kelas  from hari INNER JOIN kelas on hari.id_hari = kelas.id_kelas  order by nama_kelas";
														 $query1 = "SELECT * FROM hari NATURAL JOIN kelas ORDER BY id_hari";
														 $result = mysqli_query($koneksi, $query1);
														 $query2 = "SELECT * FROM kelas ORDER BY id_kelas";
											...
											<div class="modal fade" id="edit_modal<?php echo $fetch['id_soal']?>"
												aria-hidden="true">
												...
												<div class="modal-dialog modal-dialog-centered">
													...
													<div class="modal-content">
														...
														<form autocomplete="off" method="POST" action="update_soal.php">

															<div class="modal-header">

																<h4 class="modal-title">Ubah data mapel dan soal</h4>
																...
																<div class="col-md-6">
																	...
																	<div class="form-group">
																		...
																		<input type="text" name="nama_mapel"
																			class="form-control"
																			value="<?php echo $fetch['nama_mapel']?>"
																			required="required" />
									...
									while($data = mysqli_fetch_assoc($result) ){?>
																	...
																	<div class="form-group">
																		...
																		<input readonly name="nama_kelas"
																			class="form-control"
									...
									while($data1 = mysqli_fetch_assoc($result1) ){?>
																	...
																	<div class="form-group">
																		...
																		<input name="link_soal"
																			class="form-control"
																			value="<?php echo $fetch['link_soal']?>"
																			required="required" />
														...
														if (uname == 0) {
															...
															$.ajax({
																...
																success: function (hasil) {
																	if (hasil > 0) {
																		$('#result1').text(
																			'Ekstrakulikuler Tidak Bisa diubah, atau sama dengan ekskul yang sudah ada'
																		);
																	} else {
											...
											<div class="modal fade" id="form_modal" aria-hidden="true">
												<div class="modal-dialog modal-dialog-centered">
													<div class="modal-content">
														...
														<form autocomplete="off" method="POST" action="save_hari.php">
															<div class="modal-header">
															...
															<div class="modal-body">
																...
																<div class="col-md-6">
																	...
																	<div class="form-group">
																		...
																		<input type="text" id="nama_ekskul"
																			name="nama_hari" class="form-control"
																			required="required" />
																		<div id="result"></div>
																	</div>
										...
										if (uname == 0) {
											...
											$.ajax({
												...
												success: function (hasil) {
													if (hasil > 0) {
														$('#result').text(
															'Ekstrakulikuler Tidak Bisa Ditambah, Karena Sudah Ada'
														);
													} else {
											...
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<input type="hidden" name="id_hari"
														value="<?php echo $fetch1['id_hari']?>" class="form-control" />
						...
						<br /> -->
												...
												<div class="form-group">
													...
													<input type="text" name="password" class="form-control"
														value="<?php echo $fetch['tgl_lahir']?>" required="required" />
								...
								<footer class="main-footer">
									<strong> &copy; 2020 <a href="http://instagram.com/adithairun">Adit Hairun</a> All
